...
```{r}
     ...
     negated_words <- bigrams_separated %>%
          ...
          ungroup()
```
At this point we begin to make network graphs, first showing the cost common word combinations for *non-smokers. You could then repeat and modify the chunk for smokers*.
...
```
Finally, as in Chapter 4 of Silge and Robinson, here's an alternative and more attractive network graph. This will use the same subset of participants as the one created above.
